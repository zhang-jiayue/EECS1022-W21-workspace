...
public class Utilities {
	...
	public static String getGeometricSequence(int ft, int ratio) {
		 ...
		 */
		int term1 = ft;					// First term of the sequence
		int term2 = term1 * ratio;		// Second term equals FT times ratio
		int term3 = term2 * ratio;
		int term4 = term3 * ratio;
		int term5 = term4 * ratio;
		
		double avg = (term1 + term2 + term3 + term4 +term5) / 5.0;
		String seq = String.format("[%d][%d][%d][%d][%d]", term1, term2, term3, term4, term5);

		result = seq + " has average " + avg;
	...
	public static String getTimeConversion(int seconds) {
		...
		result = String.format("%d days %d hours %d minutes %d seconds", days, hours, minutes, seconds2);
